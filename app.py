...
👤 *Username:* {username}
⏰ *Time:* {current_time}
🤖 *System:* RAHAT ZAINAB E2EE Facebook Automation
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END RAHAT ZAINAB HERE]",
...
st.markdown('<div class="footer">Made with ❤️ by RAHAT ZAINAB| © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
